					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "fiori app title",
									"targetURL": "#publicapp-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"publicapp-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=publicapp",
									"url": sap.ui.require.toUrl("publicapp")
								}
							}
						}
					}
